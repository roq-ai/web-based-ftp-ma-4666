...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'member.create': { roles: ['owner'], key: 'member-joined-company', tenantPath: ['company', 'member'], userPath: [] },
  'member.delete': { roles: ['owner'], key: 'member-left-company', tenantPath: ['company', 'member'], userPath: [] },
  'ftp_setting.update': {
    roles: ['member'],
    key: 'ftp-settings-updated',
    tenantPath: ['company', 'ftp_setting'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['member', 'owner'];
