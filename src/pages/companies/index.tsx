...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'ftp_setting.count', 'invitation.count', 'member.count', 'task.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('ftp_setting', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'ftp_setting',
          header: 'Ftp Setting',
          accessorKey: 'ftp_setting',
          cell: ({ row: { original: record } }: any) => record?._count?.ftp_setting,
        }
      : null,
    ...
    hasAccess('member', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Member',
          accessorKey: 'member',
          cell: ({ row: { original: record } }: any) => record?._count?.member,
        }
      : null,
