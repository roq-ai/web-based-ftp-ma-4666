...
type ColumnType = ColumnDef<MemberInterface, unknown>;
...
export function MemberListPage(props: MemberListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<MemberInterface>>(
