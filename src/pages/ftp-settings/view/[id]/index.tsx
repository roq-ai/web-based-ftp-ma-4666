...
import { getFtpSettingById } from 'apiSdk/ftp-settings';
import { FtpSettingInterface } from 'interfaces/ftp-setting';

function FtpSettingViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('ftp_setting', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/ftp-settings/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Host" text={data?.host} />
